...
pub fn st_xmax() -> Arc<ScalarUDF> {
    Arc::new(ScalarUDF::new_from_impl(XMaxUdf {
        signature: Signature::user_defined(Volatility::Immutable),
        aliases: vec!["st_xmax".to_owned()],
    }))
}
...
impl ScalarUDFImpl for XMaxUdf {
