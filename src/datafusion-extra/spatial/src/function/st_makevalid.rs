...
pub fn st_makevalid() -> Arc<ScalarUDF> {
    Arc::new(ScalarUDF::new_from_impl(MakeValidUdf {
        signature: Signature::user_defined(Volatility::Immutable),
        aliases: vec!["st_makevalid".to_owned()],
    }))
}
...
impl ScalarUDFImpl for MakeValidUdf {
