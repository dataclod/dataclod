...
pub fn st_ymax() -> Arc<ScalarUDF> {
    Arc::new(ScalarUDF::new_from_impl(YMaxUdf {
        signature: Signature::user_defined(Volatility::Immutable),
        aliases: vec!["st_ymax".to_owned()],
    }))
}
...
impl ScalarUDFImpl for YMaxUdf {
