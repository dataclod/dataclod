...
pub fn st_xmin() -> Arc<ScalarUDF> {
    Arc::new(ScalarUDF::new_from_impl(XMinUdf {
        signature: Signature::user_defined(Volatility::Immutable),
        aliases: vec!["st_xmin".to_owned()],
    }))
}
...
impl ScalarUDFImpl for XMinUdf {
