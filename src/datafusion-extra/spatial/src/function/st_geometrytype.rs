...
pub fn st_geometrytype() -> Arc<ScalarUDF> {
    Arc::new(ScalarUDF::new_from_impl(GeometryTypeUdf {
        signature: Signature::user_defined(Volatility::Immutable),
        aliases: vec!["st_geometrytype".to_owned()],
    }))
}

#[derive(Debug, PartialEq, Eq, Hash)]
struct GeometryTypeUdf {
    signature: Signature,
    aliases: Vec<String>,
}
